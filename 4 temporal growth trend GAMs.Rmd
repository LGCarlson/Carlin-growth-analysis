...
fs_smooth_facet_rug<-plot_smooths(fs.gam2,ReleaseYear,SeaAge) +
  facet_wrap(~SeaAge, labeller = type_labeller) + 
  geom_rug(aes(x=ReleaseYear,y=FS.incr,color=SeaAge),data=gam.dat, na.rm = T,alpha = 0.25, position = "jitter", sides="bl") +
  ...
  axis.ticks.x.bottom = element_blank(), axis.title.y = element_blank(), 
  axis.line = element_line(color="grey"), panel.border = element_blank())
...
fw_smooth_facet_rug<-plot_smooths(fw.gam2,ReleaseYear,SeaAge) +
  facet_wrap(~SeaAge, labeller = type_labeller) + 
  geom_rug(aes(x=ReleaseYear,y=FW.incr,color=SeaAge),data=gam.dat, na.rm = T,alpha = 0.25, position = "jitter", sides="bl") +
  scale_y_continuous(limits = c(0,1.5)) + 
  scale_color_manual(values=c("#00608A","#ABB400"),name = "Recapture", labels = c("At sea", "Homewater")) +
  scale_fill_manual(values=c("#00608A","#ABB400"),name = "Recapture", labels = c("At sea", "Homewater")) + 
  scale_linetype_discrete(name = "Recapture", labels = c("At sea", "Homewater")) + LGCtheme  +
  theme(legend.position = "none") +  
  labs(x="Smolt Year", y = "First winter increment (mm)") +
  theme(axis.title.x.bottom = element_blank(), axis.text.x.bottom = element_blank(),
...
y2_smooth_facet_rug<-plot_smooths(y2.gam2,ReleaseYear,SeaAge) +
  facet_wrap(~SeaAge,labeller = type_labeller) + 
  geom_rug(aes(x=ReleaseYear,y=DAW.incr,color=SeaAge),data=gam.dat, na.rm = T,alpha = 0.25, position = "jitter", sides="bl") +
  scale_y_continuous(limits = c(0,1.5)) +
  scale_x_continuous(breaks = seq(1970,1990,10)) +
  scale_color_manual(values=c("#00608A","#ABB400"),name = "Recapture", labels = c("At sea", "Homewater")) +
  scale_fill_manual(values=c("#00608A","#ABB400"),name = "Recapture", labels = c("At sea", "Homewater")) + 
  scale_linetype_discrete(name = "Recapture", labels = c("At sea", "Homewater")) +  LGCtheme  +
  theme(legend.position = "none",strip.text = element_blank(), axis.title.y = element_blank(), 
  axis.line = element_line(color="grey"), panel.border = element_blank()) +  
